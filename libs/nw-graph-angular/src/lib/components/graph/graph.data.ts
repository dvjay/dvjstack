...
export const config = {
    ...
    "node": { "parentRawPath": ["data", "1", "printSet"],
              ...
              "nodeTypes": [{ "name": "gfctEntity",
                              ...
                              "nodeAttributes": [ { "key": "v_id", "displayName": "Node ID", "rawPath": ["v_id"], "tooltip": true },
                                                  ...
                                                  { "key": "neighboursLoaded", "displayName": "isLoaded", "rawPath": ["isLoaded"], "tooltip": true },
                                                  { "key": "collapsed", "displayName": "collapsed", "rawPath": ["collapsed"], "tooltip": true },
    ...
    "alert": {
      "nodeAttributes": [{ "nodeType": "gfctCase", "attribute": "casetype", "condition": "typeof value === 'string' && (value.toUpperCase() === 'AML' || value.toUpperCase() === 'FRD')", "position": "NE", "message": "AML/FRD Alert", "color": "#fdee00"},
                          ...
                          { "nodeType": "gfctAddress", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctSSN", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctPhone", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctEmail", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctEin", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctITN", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctCase", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"},
                          { "nodeType": "gfctSAR", "attribute": "isSkewed", "condition": "typeof value === 'string' && value.toUpperCase() === 'TRUE'", "position": "NW", "message": "Skewed Node", "color": "#ffe800"}]
    }
  }; 
